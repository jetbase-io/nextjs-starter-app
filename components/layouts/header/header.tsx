...
import { PLANS_ROUTE, PROFILE_ROUTE } from '../../../store/constants/route-constants';
import { FULL_SIGN_OUT_URL, SIGN_OUT_URL } from '../../../store/constants/api-contstants';
import { useRouter } from 'next/router';

const pages = [
  { title: "Profile", route: PROFILE_ROUTE },
  { title: "Plans", route: PLANS_ROUTE },
];
const settings = [
  { title: "Sign Out", route: SIGN_OUT_URL },
  { title: "Full Sign Out", route: FULL_SIGN_OUT_URL }
];
